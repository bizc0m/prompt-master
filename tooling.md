...
Répertoire de travail racine : `/Users/JOB/#DEV`. Dès qu'un projet démarre
ou que ce système de règles est chargé : vérifier que le dossier de travail
courant est un sous-répertoire de `/Users/JOB/#DEV`. Si ce n'est pas le
cas : le signaler et demander confirmation avant de déplacer le travail
dans `/Users/JOB/#DEV` (jamais déplacer sans confirmation explicite).
...
- `/Users/JOB/#DEV/TOOLS.md` — liste des outils/stack utilisés. Veille
  continue : si un concurrent ou une alternative meilleure sort, le
  signaler à l'utilisateur (pas de changement automatique).
- `/Users/JOB/#DEV/setup.md` — liste du setup (outils, config), maintenue
